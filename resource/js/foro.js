    ...
    $.ajax({
        ...
        "<div class='heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp' data-wow-duration='1200ms' data-wow-delay='300ms'>"+   
          ...
          "<p>Adam Torrez "+fecha+"</p>"+  
            ...
            "<a class='own-icon fa fa-pencil' onclick='new_mesage(" + '"' + idtp + '"' + ", "+'"' +fecact+ '"'+", "+'"' +idresp+ '"'+", "+'"' +idu+ '"'+");' data-toggle='modal' data-target='#regmsg' style='cursor: pointer' href='javascript:void(0)'></a>"+ 
          "</div>"+
        "</div>"+
      "</div>"+ 
    ...
    if(valores.length > 0){
        ...
        "<div class='row'>"+
          "<div class='wow fadeInUp' data-wow-duration='1000ms' data-wow-delay='400ms'>"+
            ...
            "</div>"+
            "<div class='post-meta'>"+
                "<a><i class='fa fa-comments-o'></i> "+valores[i][2]+" Comentario(s)</a>"+
                "<a class='own-icon fa fa-pencil' onclick='new_mesage(" + '"' + idtp + '"' + ", "+'"' +fecact+ '"'+", "+'"' +idresp+ '"'+", "+'"' +idu+ '"'+");' data-toggle='modal' data-target='#regmsg' style='cursor: pointer' href='javascript:void(0)'></a>"+
            "</div>"+  
          "</div>"+              
        "</div>"+                
...
function new_mesage(idtp, fecact, idresp, idu) {
    $('#idtop').val(idtp);
    $('#idrpm').val(idresp);
    $('#fecact').val(fecact);
    $('#idmu').val(idu);
