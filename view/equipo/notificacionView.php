<script>
    function recargarnot(){
        location.href="http://localhost:8080/procreator/view/include/main.php";
    }
</script>
<div class="row" id="notify" style="visibility: hidden">
    <div class="col-lg-12">
        <h2 class="page-header" style="color: rgba(128, 128, 128, 0.9);"><span class="icon-bell"> </span> <b>Notificaciones</b></h2>
        <a class="icon-arrow-up" href="#wrapper" onclick="recargarnot()"> </a>
    </div>
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Lista de Notificaciones
                <a class="icon-mail2" style="cursor: pointer" href="javascript:void(0)" data-toggle="modal" data-target="#regnot"></a>
            </div>
            <div class="panel-body" id="listnotif">
...
<div class="modal fade" id="regnot" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: rgba(0, 76, 153, 0.2);">
            <div class="modal-header">
                ...
                <h3 class="modal-title text-center" style="color: rgba(255, 255, 255, 0.9)"><b>Enviar Notificacion</b></h3>
            </div>
            <div class="modal-body">
                <div class="alert alert-success text-center" id="notexit" style="display:none;">
                    <span class="glyphicon glyphicon-ok"> </span><span> El mensaje ha sido enviado</span>
                </div>
                <form class="form-horizontal" id="regnotif">
                    <div class="form-group" style="margin-bottom: 15px">
                        <label for="msg" class="control-label col-xs-5" style="color: rgba(255, 255, 255, 0.8)">Mensaje :</label>
                        <div class="col-xs-5">
                            <input id="msg" name="msg" type="text" class="form-control" placeholder="Ingrese el mensaje" style="background-color: rgba(255, 255, 255, 0.8); height: auto; width: auto; border-radius: 2px">
                        </div>
                    </div>
                    <?php $timezone="Europe/Madrid";
                          $dt=new datetime("now",new datetimezone($timezone)); ?>
                    <div class="form-group" style="margin-bottom: 15px">
                        <label for="ast" class="control-label col-xs-5" style="color: rgba(255, 255, 255, 0.8)">Asunto :</label>
                        <div class="col-xs-5" id="nasunt">
                            
                        </div>
                    </div>
                    <div class="form-group" style="margin-bottom: 15px">
                        <label for="contn" class="control-label col-xs-5" style="color: rgba(255, 255, 255, 0.8)">Contacto :</label>
                        <div class="col-xs-5" id="ncont">
            ...
            <div class="modal-footer">  
                ...
                <button onclick="registernot('<?php echo $_SESSION['idu']; ?>', '<?php echo gmdate("Y-m-d",(time()+$dt->getOffset())); ?>', '<?php echo gmdate("H:i:s",(time()+$dt->getOffset())); ?>');" type="button" class="btn btn-primary" style="font-size: 12px; border-radius: 4px"><span class="icon-mail2"></span> Enviar</button>
            </div>
        </div>
    </div>
</div>
