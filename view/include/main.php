...
<html lang="en">
    <head>
        ...
        <script>
            function isrange(mina, mint){
                if(mina===mint || mina==(mint+1) || mina===(mint-1)) return true; else return false;
            }
            setInterval(
                function (){
                    $.ajax({
            ...
            setInterval(
                        ...
                        if(valores.length>0){
                            ...
                            for (i = 0; i < valores.length; i++) {
                                ...
                                if(notif=='Nuevo Grupo!!!'){
                                    txtnf="href='javascript:void(0)' onclick='showgroup(), listgrupo("+admin+"), changenot("+id+");'";
                                    ...
                                    txtnf="href='javascript:void(0)' onclick='shownotify(), listnotify("+adm+"), get_notifcont("+adm+"), get_asunt(), changenot("+id+");'";
                                }
                            ...
                            html="<li><a class='text-center' href='#'>"+
                ...
                function ver_proc(){
                    $.ajax({
                        ...
                        var adm='<?php echo $_SESSION['idu']; ?>'; //alert(adm);
                        if(valores.length>0){
                            html=''; var j=0;
    ...
    <body onload="showproyecto(), listproyecto('<?php echo $_SESSION['idu']; ?>');">
        ...
        <div id="wrapper">
                        ...
                        <ul class="nav" id="side-menu">
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" onclick="showrecurso(), lista_recurso('<?php echo $_SESSION['idu']; ?>', '<?php echo $_SESSION['name']; ?>'), get_recsub('<?php echo $_SESSION['idu']; ?>');">Recurso</a>
                                    </li>
                                    <li>
                                        <a href="#foro" onclick="listforo('<?php echo $_SESSION['idu']; ?>'), get_fgroup('<?php echo $_SESSION['idu']; ?>');">Foro</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" onclick="showsubtarea(), lista_subtarea('<?php echo $_SESSION['idu']; ?>'), get_subproc('<?php echo $_SESSION['idu']; ?>'), get_subcont('<?php echo $_SESSION['idu']; ?>'), get_subplazo();">Subtarea</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div id="page-wrapper">
                <?php include '../equipo/foroView.php'; ?>
            </div>
            
            <div id="page-wrapper">
                <?php include '../equipo/mensajeView.php'; ?>
            </div>
        </div>
        ...
        <script src="../../resource/js/foro.js"></script>
        <?php
